<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Customer.aspx.cs" Inherits="Stock_Management_System.Customer" %>
        ...
        <div class="row">
            ...
            <div class="col-sm-4 mt-5">
                ...
                <div class="input-group pt-2">
                    ...
                    <asp:TextBox ID="Customer_Name" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-lg" runat="server" ></asp:TextBox>
                  ...
                  <div class="input-group pt-3">
                    <span class="input-group-text" id="inputGroup-sizing-lg">Customer Gender</span>
                      <asp:DropDownList  ID="Customer_Gender" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-lg" runat="server">
                  ...
                  <div class="input-group pt-3">
                    ...
                    <asp:TextBox ID="Customer_Phone" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-lg" runat="server"></asp:TextBox>
