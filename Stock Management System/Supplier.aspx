<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Supplier.aspx.cs" Inherits="Stock_Management_System.Supplier" %>
            ...
            <div class="col-sm-4 mt-5">
                ...
                <div class="input-group pt-2">
                  ...
                  <div class="input-group pt-3">
                    <span class="input-group-text" id="inputGroup-sizing-lg">Supplier Address</span>
                    <asp:TextBox ID="Supplier_Address" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-lg" runat="server"></asp:TextBox>
                  ...
                  <div class="input-group pt-3">
                    <span class="input-group-text" id="inputGroup-sizing-lg">Supplier Mail</span>
